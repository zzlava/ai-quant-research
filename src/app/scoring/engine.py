        ...
        rows = [
            {
                ...
                "regime_score": r.breakdown.regime_score,
                "quality_score": r.breakdown.quality_score,
                "improvement_score": r.breakdown.improvement_score,
                "value_score": r.breakdown.value_score,
                "momentum_score": r.breakdown.momentum_score,
                "size_score": r.breakdown.size_score,
                "institutional_score": r.breakdown.institutional_score,
                "sector": r.sector,
